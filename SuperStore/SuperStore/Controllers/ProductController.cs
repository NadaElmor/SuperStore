...
namespace SuperStore.Controllers
{
    public class ProductController : BaseController
    {
        ...
        public ProductController(IGenericRepositery<Product> productRepositery, IMapper mapper, IGenericRepositery<ProductType> categoryRepositery, IGenericRepositery<ProductBrand> productBrandRepositery)
        {
